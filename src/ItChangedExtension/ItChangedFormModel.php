...
/**
 * Class ItChangedFormModel
 * Example:
 *      class MyForm extends ItChangedExtension\ItChangedFormModel { ... }
 *
 * if you not use composer autoload insert into your index.php before yii loading
 * this line: (pls check path)
 *      include_once "./protected/extensions/itchanged/ItChangedFormModel.php";
 *
 * @author https://github.com/One-art
 * @version 0.1
 */
class ItChangedFormModel extends CFormModel {
