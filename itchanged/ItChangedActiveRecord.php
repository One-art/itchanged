...
/**
 * Class ItChangedActiveModel
 *
 * Example:
 *      class MyActiveModel extends ItChangedExtension\ItChangedActiveModel { ... }
 *
 * if you not use composer autoload insert into your index.php before yii loading
 * this line: (pls check path)
 *      include_once "./protected/extensions/itchanged/ItChangedActiveModel.php";
 *
 * @author https://github.com/One-art
 * @version 0.1
 */
class ItChangedActiveRecord extends CActiveRecord {
